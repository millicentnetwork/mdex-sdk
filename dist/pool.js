...
class CrocPoolView {
    ...
    initPool(initPrice) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const gasEst = yield cntx.dex.estimateGas.userCmd(cntx.chain.proxyPaths.cold, calldata, txArgs);
            Object.assign(txArgs, { gasLimit: gasEst.add(utils_2.GAS_PADDING) });
    ...
    sendCmd(calldata, txArgs) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const gasEst = yield cntx.dex.estimateGas.userCmd(cntx.chain.proxyPaths.liq, calldata, txArgs);
            Object.assign(txArgs, { gasLimit: gasEst.add(utils_2.GAS_PADDING) });
